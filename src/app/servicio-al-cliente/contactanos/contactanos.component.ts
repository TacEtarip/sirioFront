...
export class ContactanosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag({ property: 'og:url', content: 'https://inventario.siriodinar.com/servicio-al-cliente/contactanos' });
    this.metaTagService.updateTag({ property: 'og:title', content: 'Contactanos | Sirio Dinar' });
    ...
    this.formContacto = this.fb.group({
      nombre: this.fb.control({value: '', disabled: false}, Validators.compose([
        Validators.required,
        Validators.pattern(/^[a-zA-Z\s]+$/),
        Validators.minLength(2),
        Validators.maxLength(45)
      ])),
      apellido: this.fb.control({value: '', disabled: false}, Validators.compose([
        Validators.required,
        Validators.pattern(/^[a-zA-Z\s]+$/),
        Validators.minLength(2),
        Validators.maxLength(45)
      ...
      mensaje: this.fb.control('', Validators.compose([
        Validators.required,
  ...
  enviarMensaje(mensajeInfo: {nombre: string, apellido: string, email: string, mensaje: string}) {
